\documentclass[aps,prm,reprint,onecolumn,groupedaddress]{revtex4-2}
...
\textit{Independent researcher, Buz\u{a}u, Romania}\\
toader\_alexandru@yahoo.com}
...
All harmonic features, BTE thermal conductivities, analysis scripts, and 37 reproducibility tests across four test files (ceiling, residual, independence, outliers) are publicly available at \url{https://github.com/alex-toader/st_kappa_ceiling} (DOI: \href{https://doi.org/10.5281/zenodo.19570129}{10.5281/zenodo.19570129}). The underlying force constants are from PhononDB~\cite{togo2023}.
...
\bibitem{togo2023} A.~Togo, L.~Chaput, T.~Tadano, and I.~Tanaka, J. Phys.: Condens. Matter \textbf{35}, 353001 (2023).
